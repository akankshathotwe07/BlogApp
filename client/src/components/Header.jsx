  ...
  return (
    <div className='mx-8 sm:mx-24  relative'>
      <div className='text-center mt-20 mb-8'>
        ...
        text-gray-700'> Your Space to <span className='text-primary'> Blog</span> <br />Where Stories Begin</h1>

      <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs *:text-gray-500'>
        A place to express your thoughts and explore inspiring stories. Simple, creative, and made for every writer....Read, write, and connect through meaningful blogs.</p>
     ...
     border border-gray-300 bg-white rounded overflow-hidden' >
        ...
        <button className='bg-primary text-white px-8 py-2 m-1.5 rounded 
